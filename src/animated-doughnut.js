...
(function setupSegmentClass() {
  ...
  var Segment = function(doughnut) {
    var segment = this;

    segment.doughnut = doughnut;
    segment.index = doughnut.segments.length;
  ...
  Segment.prototype.init = function() {
    ...
    segment.color = segment.data.color || segment.doughnut.options.defaultColor;
    segment.value = segment.data.value || 0;
...
(function setupDoughnutClass() {
  ...
  Doughnut.prototype.init = function() {
    ...
    for ( var i=0; i<doughnut.data.data.length; i++ ) {
      doughnut.segments.push(new AnimatedDoughnut.Segment(doughnut));
    };
  ...
  AnimatedDoughnut.Chart = Doughnut;
})();
